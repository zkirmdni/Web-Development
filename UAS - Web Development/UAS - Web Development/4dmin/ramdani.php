...
<div class="row">
    ...
    <div class="col-sm-10">
        ...
        if(isset($_POST["Simpan"])) {
            $ramdaniID = $_POST['ramdaniid'];
            $ramdaniKOTA = $_POST['ramdanikota'];
            $destinasiKODE = $_POST['destinasikode'];

            mysqli_query($connection, "INSERT INTO ramdani (ramdaniID, destinasiNAMA, destinasiKODE) VALUES ('$ramdaniID', '$ramdaniKOTA', '$destinasiKODE')");
            header ("location:ramdani.php");
        }
        ?>

        <form method="POST">
            <div class="mb-3 row">
                <label for="ramdaniid" class="col-sm-2 col-form-label">Kode Destinasi</label>
                <div class="col-sm-10">
            ...
            <div class="mb-3 row">
                <label for="ramdanikota" class="col-sm-2 col-form-label">Nama Destinasi</label>
                <div class="col-sm-10">
