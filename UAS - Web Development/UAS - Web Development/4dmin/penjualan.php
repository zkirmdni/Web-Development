...
<?php
	...
	if(isset($_POST['Simpan']))
	{
		...
		$hpTYPE = $_POST['hpTYPE'];
		mysqli_query($connection, "insert into penjualanhp values ('$hpKODE','$hpNAMA','$garansiKODE','$hpTYPE')");
...
<div class="col-sm-10">
<input type="text" class="form-control" id="hpKODE" name="hpKODE">
</div>
</div>
<div class="mb-3 row">
<label for="hpNAMA" class="col-sm-2 col-form-label">Nama Handphone</label>
<div class="col-sm-10">
<input type="text" class="form-control" id="hpNAMA" name="hpNAMA" >
</div>
</div>
<div class="mb-3 row">
<label for="garansiKODE" class="col-sm-2 col-form-label">Garansi</label>
<div class="col-sm-10">
<input type="text" class="form-control" id="garansiKODE" name="garansiKODE">
</div>
</div>
<div class="mb-3 row">
...
<td width="5px">
    <a href="dashboard5.php?ubah=<?php echo $row["hpKODE"]?>"
