...
if(isset($_POST['Simpan']))
{
    ...
    mysqli_query($connection, "UPDATE pusatoleh SET barangNAMA='$barangNAMA', barangHARGA='$barangHARGA', barangTYPE='$barangTYPE' WHERE barangKODE='$barangKODE'");
...
$editdestinasi = mysqli_query($connection, "SELECT * FROM pusatoleh WHERE barangKODE ='$kodedestinasi'");
...
<div class="col-sm-10">
<input type="text" class="form-control" id="barangKODE" name="barangKODE" value="<?php echo $rowedit["barangKODE"]?>">
</div>
</div>
<div class="mb-3 row">
<label for="barangNAMA" class="col-sm-2 col-form-label">Nama Barang</label>
<div class="col-sm-10">
<input type="text" class="form-control" id="barangNAMA" name="barangNAMA" value="<?php echo $rowedit["barangNAMA"]?>">
</div>
</div>
<div class="mb-3 row">
<label for="barangHARGA" class="col-sm-2 col-form-label">Barang Harga</label>
<div class="col-sm-10">
<input type="text" class="form-control" id="barangHARGA" name="barangHARGA" value="<?php echo $rowedit["barangHARGA"]?>">
</div>
</div>
<div class="mb-3 row">
...
<select class="form-control" id="barangTYPE" name="barangTYPE">
        <option value="<?php echo $rowedit["barangTYPE"]?>"><?php echo $rowedit
                ['barangTYPE'] ?></option>
...
<td width="5px">
    <a href="pusatolehedit.php?ubah=<?php echo $row["barangKODE"]?>"
