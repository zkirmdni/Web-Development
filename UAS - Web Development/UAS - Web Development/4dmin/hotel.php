...
<form method="POST">
<div class="mb-3 row">
<label for="hotel0137" class="col-sm-2 col-form-label">Kode Hotel</label>
<div class="col-sm-10">
...
<div class="mb-3 row">
<label for="kategori0137" class="col-sm-2 col-form-label">Kategori Kode</label>
<div class="col-sm-10">
...
<form method="POST">
  <div class="form-group row mb-2">
    <label for="cari" class="col-sm-3">Alamat Hotel</label>
    <div class="col-sm-6">
      <input type="text" name="cari" class="form-control" id="cari" value="<?php if(isset($_POST['cari'])) {echo $_POST['cari'];}?>" placeholder="Cari Alamat Hotel">
    </div>
...
<td width="5px">
<a href="hotelhapus.php?hapus=<?php echo $row["hotel0137"]?>"
