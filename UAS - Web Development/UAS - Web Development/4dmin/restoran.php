...
<?php 
	...
	if(isset($_POST['Simpan']))
	{
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "png"))
		{
			...
			mysqli_query($connection, "INSERT INTO resto VALUES ('$restoMAKAN', '$restoMINUM', '$namafile', '$fotoMENU')");
...
<div class="col-sm-10">
	...
	<form method="POST" enctype="multipart/form-data">
		<div class="form-group row mb-3">
			<label for="restoMAKAN" class="col-sm-2 col-form-label">Makanan</label>
			<div class="col-sm-10">
				<input type="text" class="form-control" id="restoMAKAN" name="restoMAKAN" placeholder="Kode Menu">
			</div>
		</div>
		...
		<div class="form-group row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="restoMINUM" name="restoMINUM" placeholder="Nama Menu">
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				...
				<p class="help-block">Unggah Foto</p>
			</div>
		</div>
  ...
  <div class="form-group row mb-2">
    <label for="search" class="col-sm-3">Nama Menu</label>
    <div class="col-sm-6">
      <input type="text" name="search" class="form-control" id="search" value="<?php if(isset($_POST['search'])) {echo $_POST['search'];}?>" placeholder="Cari Nama Menu">
    </div>
		...
		while($row = mysqli_fetch_array($query))    
			{ ?>
				<tr>
					...
					<td>
						<a href="dashboard7.php?ubah=<?php echo $row['restoMAKAN']?>" 
